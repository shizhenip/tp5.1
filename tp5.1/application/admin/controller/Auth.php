...
class Auth extends BasicAdmin
{
    ...
    public function apply()
    {
        ...
        switch (strtolower($this->request->get('action', '0'))) {
            ...
            case 'save':
                ...
                LogService::write('系统管理', '更改权限' . session('user.realname'));
    ...
    public function add()
    {
        if ($this->request->isPost()) {
            ...
            $result = $this->validate($post_data, 'AuthValidate');
            LogService::write('系统管理', '添加权限');
            if (true !== $result) {
                $this->error($result);
            }
        }
